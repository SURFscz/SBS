const nl = {
    ...
    welcome: {
        ...
        creating: "Een samenwerking beginnen",
    ...
    servicePageHeaders: {
        ...
        notAvailable: " & beschikbaar voor <span class='not-available'>geen enkele organisatie </span>",
        availableSingle: " & beschikbaar voor <span class='all-connected'>{{count}} organisatie</span>",
        availableMultiple: " & beschikbaar voor <span class='all-connected'>{{count}} organisaties</span>",
        all: "alle",
