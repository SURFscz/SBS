...
I18n.translations.nl = {
    ...
    user: {
        ...
        sshKeyError: "Deze SSH cipher wordt niet herkend. In de documentatie op https://edu.nl/87btm staan de ondersteunde formaten.",
    ...
    collaboration: {
        ...
        disableJoinRequests: "Lidmaatschapsverzoek uitschakelen voor deze samenwerking.",
    ...
    welcomeDialog: {
        ...
        info: "Om lid te worden van deze samenwerking moet je de acceptable use policy (AUP) en het privacybeleid van de dienst(en) accepteren.",
