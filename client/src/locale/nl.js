...
I18n.translations.nl = {
    ...
    registration: {
        ...
        noJoinRequestCollaboration: "Samewerking {{name}} ondersteund geen verzoeken voor lidmaatschap.",
    ...
    collaboration: {
        ...
        disableJoinRequests: "Niet-leden kunnen geen veroek doen om lid te worden",
    ...
    apiKeys: {
        ...
        info: "Met API keys kan de API van SBS worden gebruikt. Zie <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://github.com/SURFscz/SBS/wiki/External-API\"'>de wiki</a> voor meer details.",
        backToOrganisationDetail: "Terug naar mijn organisatie {{name}}",
        secretDisclaimer: "Sla het secret op en bewaar het veilig. Je kan deze code maar één keer zien. Nadat de API key is opgeslagen kan je deze niet meer opnieuw zien. Bij verlies zal je de key moeten verwijderen en een nieuwe aanmaken.",
        secret: "Secret",
    ...
    invitation: {
        ...
        intendedRoleTooltip: "De beheersrechten die alle genodigden krijgen.<br/><br/>Beheerders van een samenwerking<br/>kunnen de gegevens van de samenwerking<br/> wijzigen en leden uitnodigen.<br/>Normale gebruikers kunnen alleen diensten gebruiken <br/>van autorisatie groepen waar ze lid van zijn",
        invitee_email: "Email genodigde",
        authorisationGroupsPlaceHolder: "Selecteer Autorisatie groepen",
        authorisationGroupsTooltip: "Selecteer de autorisatie groupen waar<br/>de genodigde lid van wordt<br/>nadat deze uitnodiging is geaccepteerd",
