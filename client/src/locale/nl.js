...
I18n.translations.nl = {
    ...
    models: {
        ...
        collaboration: {
            ...
            servicesStart: "Klik de knop om de dienst te starten, of lees eerst de instructies.",
    ...
    impersonate: {
        ...
        organisationAdminsOnly: "Toon alleen de admins van organisaties",
        collaboration: "Samenwerking",
        collaborationPlaceholder: "Voer de naam van een samenwerking in om de lijst met zoekresultaten te beperken",
        collaborationAdminsOnly: "Toon alleen de admins van samenwerkingen",
        user: "Gebruiker",
    ...
    collaborations: {
        ...
        dashboardAdminTooltip: "Dit is een overzicht van<br/>alle samenwerkingen waar u<br/>een van de admins van bent.",
    ...
    collaboration: {
        ...
        currentUserAdmin: "Wilt u zichzelf admin maken van deze samenwerking?",
        currentUserAdminTooltip: "Indien aangevinkt, dan wordt u toegevoegd als admin van de samenwerking",
        message: "Bericht",
        messagePlaceholder: "Persoonlijk bericht aan de admins",
        messageTooltip: "De tekst nemen we op in de <br/>e-mail aan de admins.",
        ...
        subTitle: "Beschrijf de samenwerking. Je wordt admin van de nieuwe samenwerking.",
        ...
        administratorsPlaceholder: "Nodig admins uit per e-mail",
        administratorsTooltip: "Admins van een samenwerking<br/>kunnen de samenwerking aanpassen en<br/>leden uitnodigen.<br/><br/>Voer e-mailadressen in, gescheiden door<br/>een komma, spatie of punt-komma, of druk<br/>ENTER na elk adres.",
    ...
    collaborationDetail: {
        ...
        lastAdminWarning: "Je laat deze samenwerking achter zonder admins. Hierna kan het beheer van de CO alleen worden uitgevoerd door de admins van organisatie {{name}}",
        lastAdminWarningUser: "Je bent de laatste admin in deze CO. Na je vertrek kan het beheer van de CO alleen worden uitgevoerd door de admins van organisatie {{name}}",
    ...
    organisation: {
        ...
        servicesRestricted: "Beperk ORG tot SURF diensten",
        servicesRestrictedTooltip: "Als dit aangevinkt is kunnen<br/>alleen SRAM platform admins diensten<br/>voor de samenwerkingen van deze<br/>organisatie beheren.",
        ...
        messageTooltip: "Deze tekst voegen we in de e-mail toe<br/>waarmee we de admins uitnodigen.",
        ...
        administrators: "Admins",
        administratorsPlaceholder: "Admins uitnodigen per e-mail",
        ...
        administratorsTooltip: "Admins van een organisatie<br/>kunnen samenwerkingen aanmaken<br/>binnen hun organisatie.<br/><br/>Vul e-mailadressen van uit te nodigen<br/>mensen in, gescheiden door een komma,<br/>spatie of punt-komma, of voeg ze<br/>stuk-voor-stuk toe via de enter toets.",
        role: "Rol",
        new: "Nieuwe organisatie",
        admin: "Admin",
        manager: "Manager",
        ...
        anotherAdmin: "We raden aan meerdere admins uit te nodigen.",
    ...
    organisationInvitation: {
        ...
        requiredAdministrator: "Er is minimaal 1 e-mailadres van een admin nodig voor een uitnodiging.",
        role: "Rol",
        ...
        flash: {
            ...
            notFound: "Deze uitnodiging is reeds geaccepteerd of afgewezen. Als je denkt dat er een probleem is, neem dan contact op met je CO-admin (of met SRAM-ondersteuning op sram-support@surf.nl)."
        },
    },
    apiKeys: {
    ...
    invitation: {
        ...
        intendedRoleTooltip: "De rechten die alle genodigden krijgen.<br/><br/>CO-Admins van een samenwerking<br/>kunnen de gegevens van de samenwerking<br/>wijzigen en leden uitnodigen.<br/>Normale gebruikers kunnen alleen diensten gebruiken <br/>van groepen waar ze lid van zijn.",
    ...
    collaborationServices: {
        ...
        serviceRestrictedInfo: "Deze samenwerking is beperkt in de diensten. Alleen de SRAM-platformadmin kan diensten configureren die door deze samenwerking worden gebruikt.",
    ...
    confirmation: {
        ...
        info: "Je bent geconfigureerd als platformadmin, maar je moet dit verifiëren met een sterkere verificatie. Klik op de onderstaande knop om de upgrade van je account te starten.",
    ...
    tooltips: {
        ...
        admins: "Admin(s) van deze samenwerking",
