const nl = {
    ...
    models: {
        ...
        servicesWithoutAdmin: {
            title: "Applicatieen zonder beheerders",
            noEntities: "Er zijn geen applicatieen zonder beheerders...",
            searchPlaceHolder: "Zoek applicatieen...",
        },
        organisations: {
            title: "Organisaties",
        ...
        services: {
            title: "Applicatieen",
            noEntities: "Er zijn nog geen applicatieen...",
            searchPlaceHolder: "Zoek applicatieen...",
            ...
            backToServices: "Terug naar applicatieen",
        ...
        servicesAvailable: {
            title: "Beschikbare applicatieen",
            searchPlaceHolder: "Zoek applicatieen...",
            noEntities: "Er zijn geen applicatieen beschikbaar om toe te voegen"
        },
        servicesUsed: {
            searchPlaceHolder: "Zoek applicatieen...",
            noEntities: "Geen applicatieen in gebruik"
        },
        servicesRequested: {
            searchPlaceHolder: "Zoek applicatieen..."
        },
        ...
        collaboration: {
            ...
            services: "We werken samen in {{nbr}} applicatieen",
            joinRequestServices: "{{name}} werkt samen in {{nbr}} applicatieen",
            noServicesYet: "Waar we samenwerken",
            noServices: "Er zijn geen applicatieen gekoppeld aan je samenwerking. ",
            connectFirstService: "Wil je de eerste koppelen?",
            noServicesJoinRequest: "Applicatieen zijn alleen zichtbaar voor leden",
        ...
        invitation: {
            welcome: "Welkom in SURF Research Access Management (SRAM). Hier wordt de toegang tot onderzoeksapplicatieen geregeld voor onderzoekssamenwerkingen.",
            invited: "Je bent door <a href=\"mailto:{{email}}\">{{inviter}}</a> uitgenodigd lid te worden van {{type}} '{{collaboration}}'",
            followingSteps: "SURF Research Access Management geeft leden van onderzoekssamenwerkingen snel en veilig toegang tot onderzoeksapplicatieen.</br> Inloggen kan met je instellingsaccount of eduID.",
            steps: {
            ...
            disclaimer: "Als je doorgaat, zal SURF gegevens over jou doorsturen naar de onderzoekssamenwerking. Elke gegevensverwerking door de samenwerking, zoals het overdragen van gegevens aan applicatieen zodat je daar toegang toe hebt, is een verantwoordelijkheid van de samenwerking.",
        ...
        serviceConnectionRequests: {
            ...
            edit: "Goed- / afkeuren",
            details: "Applicatie koppelverzoek gemaakt door {{name}} op {{date}} voor samenwerking {{collaborationName}}",
            detailsWithService: "Applicatie koppelverzoek gemaakt door {{name}} op {{date}} voor samenwerking {{collaborationName}} en applicatie {{serviceName}}",
            requester: "Aanvrager",
            name: "Samenwerking",
    ...
    user: {
        ...
        ssh_keyTooltip: "Je publieke SSH-sleutel zal worden uitgewisseld met de applicatieen waar je toegang toe hebt. Je kunt je publieke SSH-sleutel ook uploaden.",
    ...
    collaboration: {
        ...
        shortNameTooltip: "Ken korte namen toe aan de samenwerkingen zodat die namen bruikbaar zijn in de via ldap te koppelen applicatieen (zoals Linux groepsnamen).<br/><br/>" +
        ...
        expiryDateTooltip: "De einddatum van de samenwerking. Na deze datum wordt de samenwerking geschorst en kunnen gebruikers van deze samenwerking geen gebruik meer maken van de applicatieen",
    ...
    services: {
        ...
        searchPlaceHolder: "Doorzoek alle applicatieen",
        toc: {
            connections: "Koppelingen",
            available: "Beschikbare applicatieen",
        }
    },
    service: {
        ...
        contact_emailTooltip: "Dit e-mailadres wordt gebruikt om met de contactpersoon van de applicatie te communiceren. Idealiter is dit een functioneel e-mailadres, zoals applicatie_A_support@service.example.com.",
        ...
        security_emailTooltip: "Het security e-mailadres wordt gecontacteerd als er security-vragen zijn. Idealiter is dit een functioneel e-mailadres, zoals applicatie_A_security@service.example.com.",
        ...
        admins: "Administratieve e-mailadressen",
    ...
    organisation: {
        ...
        shortNameTooltip: "De korte name wordt gebruikt voor LDAP-applicatieen (zoals Linux directory-namen).<br/><br/>" +
            "Alleen getallen, alfanumerieke karakers en de lage streep zijn toegstaan.",
        identifier: "Identifier",
        ...
        servicesRestrictedTooltip: "Samenwerkingen van een SURF-organisatie kunnen alleen SURF-applicatieen koppelen.",
        ...
        crmIdTooltip: "De organisatie gekoppeld aan deze service door de CRM identifier",
    ...
    organisationDetail: {
        ...
        newCollaboration: "Nieuwe samenwerking",
        services: "Applicatieen gekoppeld aan {{name}}",
        noServices: "Er zijn geen standaardapplicatieen voor deze organisatie.",
        configureServices: "Configureer applicatieen",
    ...
    invitation: {
        ...
        intendedRole: "Rol",
        intendedRoleTooltip: "De rechten die alle genodigden krijgen. Beheerders kunnen de gegevens van de samenwerking wijzigen, applicatieen koppelen en leden uitnodigen.",
        ...
        membershipExpiryDateTooltip: "Datum waarop het lidmaatschap verloopt en de gebruiker de applicatieen gekoppeld aan deze samenwerking niet meer kan gebruiken.",
        flash: {
    ...
    collaborationServices: {
        title: "Applicatieen voor samenwerking {{name}}",
        connectedServices: "Met {{name}} gekoppelde applicatieen",
        noServices: "Deze samenwerking heeft geen gekoppelde applicatieen.",
        noServiceConnectRequests: "Deze samenwerking heeft geen openstaande applicatiekoppelverzoeken.",
        searchServices: "Zoek, kies en voeg applicatieen toe aan samenwerking {{name}}",
        ...
        serviceRestrictedInfo: "Deze samenwerking is beperkt in de applicatieen. Alleen de platformbeheerder kan applicatieen configureren die door deze samenwerking worden gebruikt.",
    ...
    organisationServices: {
        title: "Applicatieen voor organisatie {{name}}",
        connectedServices: "Gekoppelde applicatieen aan {{name}}",
        noServices: "Deze organisatie heeft geen gekoppelde applicatieen.",
        searchServices: "Zoek, kies en voeg applicatieen toe aan organisatie {{name}}",
        ...
        serviceRestrictedOrganisation: "Deze applicatie kan niet worden verplicht voor alle samenwerkingen omdat deze organisatie alleen SURF-applicatieen mag koppelen.",
        flash: {
    ...
    groups: {
        ...
        servicesTitle: "Applicatieen voor groep {{name}}",
        ...
        flash: {
            ...
            addedServices: "Alle applicatieen toegevoegd aan groep {{name}}.",
        ...
        addAllServices: "Voeg alle samenwerkingsapplicatieen toe aan deze groep",
        searchServices: "Zoek, kies en voeg applicatieen toe aan groep {{name}}",
        connectedServices: "Applicatieen gekoppeld aan {{name}}",
    ...
    aup: {
        ...
        service: {
            ...
            informationServiceMultiple: "Informatie over de applicatieen",
            contact: "Contact",
            ...
            missing: {
                ...
                infoMultiple: "De acceptable use policies (AUPs) van deze applicatieen zijn gewijzigd. Lees de AUPs en geef aan of je akkoord gaat."
            },
            singleInfo: "Een applicatie gebruikt binnen deze samenwerking vereist dat je akkoord gaat met een acceptable use policy.",
            multipleInfo: "Applicatieen gebruikt binnen deze samenwerking vereisen dat je akkoord gaat met de acceptable use policies.",
            ...
            multipleInfoAccepted: "Je bent al akkoord gegaan met de acceptable use policies van de applicatieen gebruikt door deze samenwerking.",
        },
        organisation: {
    ...
    history: {
        ...
        includeServices: "Toon applicatieen",
    ...
    welcomeDialog: {
        ...
        infoMember: "Houd er rekening mee dat wanneer je lid wordt van deze samenwerking, je persoonlijke gegevens gedeeld kunnen worden met de volgende applicatieen. Neem even de tijd om de door de applicatie opgegeven beleidsdocumenten door te nemen.",
        infoAdmin: "Houd er rekening mee dat wanneer je beheerder wordt van deze samenwerking, je persoonlijke gegevens gedeeld kunnen worden met de volgende applicatieen. Neem even de tijd om de door de applicatie opgegeven beleidsdocumenten door te nemen.",
        ...
        noServices: "Nog geen applicatieen gekoppeld.",
        proceed: "Ga door naar {{name}}"
    },
    welcome: {
        title: "Hallo {{name}},",
        subTitle: "Met <strong>SURF Research Access Management</strong> kun je inloggen op onderzoeksapplicatieen en samenwerken met andere onderzoekers.",
        ...
        startCreateColl: "Je bent ingelogd via <strong>{{name}}</strong> waardoor je een samenwerking kunt aanmaken. Daarmee kun je applicatieen koppelen en onderzoekers uitnodigen.",
        startRequestColl: "Je bent ingelogd via <strong>{{name}}</strong>, en je kunt hen vragen een samenwerking voor je te maken. Nadat je verzoek is goedgekeurd, kun je applicatieen koppelen en onderzoekers uitnodigen.",
    ...
    landing: {
        header: {
            title: "Eenvoudige en veilige toegang tot onderzoeksapplicatieen voor onderzoekssamenwerkingen",
            login: "Inloggen",
        ...
        createInfo: "<p>Beheerders maken een pagina aan voor de onderzoekers van hun samenwerking.</p>" +
            "<p>Vervolgens selecteren zij applicatieen uit de catalogus om ze beschikbaar te maken voor de samenwerking.</p>",
        invite: "Uitnodigen",
        ...
        collaborate: "Samenwerken",
        collaborateInfo: "<p>De beveiligde samenwerkingspagina toont de leden en geeft toegang tot de onderzoeksapplicatieen.</p>",
    ...
    organisationMembership: {
        ...
        member: "Lidmaatschap",
        expiryDate: "Einddatum",
        expiryDateTooltip: "De einddatum van dit lidmaatschap. Hierna verloopt het lidmaatschap en kan de gebruiker geen gebruikmaken van de applicatieen van deze samenwerking.",
        update: "Opslaan",
