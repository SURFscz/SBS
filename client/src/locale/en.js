const en = {
    ...
    groups: {
        ...
        shortNameTooltip: "A application group's short name will be used (1) for groups provisioned to collaborations, prepended by short name of the application and separated by a hyphen '-' and (2) in the challenge URL generated by PAM web login..<br/><br/>" +
            "Only digits, alphanumeric characters and the underscore are allowed.",
        identifier: "Identifier",
