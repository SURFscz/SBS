const en = {
    ...
    collaborationServices: {
        ...
        send: "Send",
        flash: {
            added: "Added application {{service}} to collaboration {{name}}.",
            deleted: "Deleted application {{service}} from collaboration {{name}}.",
    ...
    serviceConnectionRequest: {
        ...
        flash: {
            declined: "Application Connect request for service {{name}} was declined",
            accepted: "Application Connect request for service {{name}} was accepted",
            deleted: "Application Connect request for service {{name}} was deleted",
