...
I18n.translations.en = {
    ...
    home: {
        ...
        tabs: {
            ...
            serviceCollaborations: "Collaborations",
    ...
    models: {
        users: {
            ...
            icon: "",
            profile: "Hi {{name}}",
            subProfile: "You are currently logged in with your institution account",
        ...
        orgMembers: {
            ...
            mailTooltipDisabled: "First select<br/>users to email",
            mailTooltip: "Email all<br/>selected members"
        },
        organisations: {
            title: "Organisations",
    ...
    collaborations: {
        ...
        dashboardAdminTooltip: "This is an aggregated view<br/>of all collaborations where<br/>you are one of the admins.",
    ...
    collaboration: {
        ...
        currentUserAdmin: "Do you want to be an admin of this collaboration?",
        ...
        messageTooltip: "The message will be included in the<br/>email to the admins.",
        ...
        administratorsTooltip: "Admins of a collaboration <br/>can edit their collaborations and<br/>invite members.<br/><br/>Add email addresses separated by comma, space <br/>or semi-colon or one-by-one using <br/>the enter key.",
    ...
    service: {
        ...
        contact_emailPlaceholder: "The email address of the contact person of this service",
        contact_emailTooltip: "This email address will be used as primary contact.<br/>Ideally this is a functional email address, like service_A_support@sp.org.",
        contactEmailRequired: "Contact email is required if automatic connection is not allowed for a service",
        status: {
            name: "Status",
            active: "Active",
            in_active: "In-active"
    ...
    organisation: {
        ...
        servicesRestrictedTooltip: "When checked the collaborations in<br/>this service are restricted and<br/>only the platform admin can<br/>configure the services.",
        ...
        schacHomeOrganisationTooltip: "The domain name of a person based<br/>on the domain name of the institution<br/> (i.e. institution.nl).<br/><br/>SAML2: urn:mace:terena.org:attribute-def:schacHomeOrganization",
        collaborationCreationAllowed: "Automatically approve collaboration creation requests?",
        collaborationCreationAllowedTooltip: "Any person can create<br/>collaborations for their home<br/>institution.<br/><br/>This requires a domain name",
        created: "Created at",
        message: "Message",
        messagePlaceholder: "Personal message to the admins",
        messageTooltip: "The message will be included in the<br/>email invitation to the admins.",
        ...
        administratorsTooltip: "Admins of an organisation <br/>can create collaborations in their organisations.<br/><br/>Add email addresses separated by comma, space <br/>or semi-colon or one-by-one using <br/>the enter key.",
        role: "Role",
    ...
    invitation: {
        ...
        inviteesTooltip: "This personal message is<br/>included in the email sent <br/>to the persons you invite",
        ...
        intendedRoleTooltipOrganisation: "The permissions granted to all invitees.<br/><br/>Admins of a organisation<br/>can edit their organisation and<br/>invite members.<br/><br/>Managers can can create,<br/>approve and manage collaborations",
        invitee_email: "Invitee email",
        ...
        messagePlaceholder: "Personal message to the admins",
        messageTooltip: "The message will be included in the<br/>email invitation to the admins.",
        inviteesMessagesTooltip: "Add email addresses separated by comma, space <br/>or semi-colon or one-by-one using <br/>the enter key.<br/>You can also copy & paste a csv file<br/>with line-separated email addresses.",
        appendAdminNote: "<br/><br/>Note: the invitees will become <strong>admin</strong> after accepting the invite.",
    ...
    organisationServices: {
        ...
        notAllowedOrganisation: "This service cannot be enabled for al collaborations<br/>because it does not allow automatic connections to collaborations.<br/><br/>Connections can still be requested by<br/>individual collaborations in your organisation.",
        notEnabledOrganisation: "This service cannot be enabled for al collaborations<br/>because this organisation is not<br/>allowed access to this service.<br/><br/>Please contact <a href=\"mailto:sram-support@surf.nl\">sram-support@surf.nl</a> to resolve this issue.",
        serviceRestrictedOrganisation: "This service cannot be enabled for al collaborations<br/>because this organisation is configured<br/>services restricted.<br/><br/>Please contact <a href=\"mailto:sram-support@surf.nl\">sram-support@surf.nl</a> to resolve this issue.",
        serviceRestrictedOrganisationAdded: "This service is enabled for al collaborations<br/>but you can't edit this<br/>because this organisation is configured<br/>services restricted.<br/>",
        flash: {
    ...
    groups: {
        ...
        deleteMemberTooltip: "Remove this member from<br/> the group {{name}}.<br/><br/><strong>NOTE</strong>: the user itself is NOT deleted.<br/>They are only no longer a <br/> member of this groups",
        deleteInvitationTooltip: "Remove this invitation from<br/> the group {{name}}.<br/><br/><strong>NOTE</strong>: the invitation itself is NOT deleted.<br/>They will not be added<br/>as a member of this group<br/>when the invitation is accepted",
        service: {
            actions: "",
            name: "Name",
            entity_id: "Entity ID",
    ...
    system: {
        ...
        runDailyJobsInfo: "Run the daily cron job to send notification emails and potentially suspend users that have not logged in for the configured period",
