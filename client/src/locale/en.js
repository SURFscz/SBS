...
I18n.translations.en = {
    ...
    authorisationGroup: {
        ...
        alreadyExists: "An authorisation group with {{attribute}} {{value}} already exists.",
        ...
        removeServiceConfirmation: "Are you sure you want to remove service {{name}} from this authorisation group?",
        removeServiceConfirmationDetails: "The following service specific information for this user will be deleted:",
        removeMemberConfirmation: "Are you sure you want to remove member {{name}} from this authorisation group?",
        ...
        addAllMembers: "Add all Collaboration members and outstanding invitees to this authorisation group",
        addAllServices: "Add all Collaboration services to this authorisation group",
        ...
        deleteServiceTooltip: "Make this service unavailable in<br/> the authorisation group {{name}}.<br/><br/><strong>NOTE</strong>: the service itself is NOT deleted.<br/>It is only no longer available<br/> for this authorisation group",
        ...
        deleteMemberTooltip: "Remove this member from<br/> the authorisation group {{name}}.<br/><br/><strong>NOTE</strong>: the user itself is NOT deleted.<br/>He / she is only no longer a <br/> member of this authorisation groups",
        deleteInvitationTooltip: "Remove this invitation from<br/> the authorisation group {{name}}.<br/><br/><strong>NOTE</strong>: the invitation itself is NOT deleted.<br/>He / she will not be added<br/>as a member of this authorisation group<br/>when the invitation is accepted",
        service: {
            actions: "",
            name: "Name",
            entity_id: "Entity ID",
