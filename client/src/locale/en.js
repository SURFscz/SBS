...
I18n.translations.en = {
    ...
    collaboration: {
        ...
        noJoinRequests: "Membership request not allowed",
        disabled: "Disabled",
        enabled: "Copy link",
    ...
    service: {
        ...
        compliancyLong: "{{compliant}} compliant",
    ...
    organisation: {
        ...
        collaborationCreationIsAllowed: "Everyone with an identity in {{schacHome}} can create collaborations.",
        collaborationCreationNotAllowed: "Only organisation admins and organisation managers can create collaborations.",
