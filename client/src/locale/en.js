...
I18n.translations.en = {
    ...
    groups: {
        ...
        flash: {
            ...
            deleted: "Successfully deleted groupgroup {{name}}",
            addedService: "Successfully added service {{service}} to groupgroup {{name}}",
            deletedService: "Successfully deleted service {{service}} from groupgroup {{name}}",
            addedServices: "Successfully added all services to groupgroup {{name}}",
            addedMember: "Successfully added user {{member}} as a member of groupgroup {{name}}",
            addedMembers: "Successfully added all users and invitations as (future ) members of groupgroup {{name}}",
            deletedMember: "Successfully deleted user {{member}} from groupgroup {{name}}",
            addedInvitation: "Successfully added user {{member}} as a member of groupgroup {{name}}",
            deletedInvitation: "Successfully deleted invitee {{invitation}} from groupgroup {{name}}",
        },
        addAllMembers: "Add all Collaboration members and outstanding invitees to this groupgroup",
        addAllServices: "Add all Collaboration services to this groupgroup",
        searchServices: "Search, select and add services to the available services for the groupgroup {{name}}",
        connectedServices: "Connected services to {{name}}",
        deleteServiceWarning: "Warning: Unlinking services from the groupgroup deletes all user information specific for that service and all linked memberships",
        deleteServiceTooltip: "Make this service unavailable in<br/> the groupgroup {{name}}.<br/><br/><strong>NOTE</strong>: the service itself is NOT deleted.<br/>It is only no longer available<br/> for this groupgroup",
        searchMembers: "Search, select and add members to the groupgroup {{name}}",
        connectedMembers: "Members of {{name}}",
        deleteMemberWarning: "Warning: Unlinking memberships from the groupgroup deletes all user information specific for that membership and all linked services",
        deleteMemberTooltip: "Remove this member from<br/> the groupgroup {{name}}.<br/><br/><strong>NOTE</strong>: the user itself is NOT deleted.<br/>He / she is only no longer a <br/> member of this groupgroups",
        deleteInvitationTooltip: "Remove this invitation from<br/> the groupgroup {{name}}.<br/><br/><strong>NOTE</strong>: the invitation itself is NOT deleted.<br/>He / she will not be added<br/>as a member of this groupgroup<br/>when the invitation is accepted",
        service: {
            actions: "",
            name: "Name",
            entity_id: "Entity ID",
