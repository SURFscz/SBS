...
I18n.translations.en = {
    ...
    user: {
        ...
        ssh_keyTooltip: "Your public SSH keys will be provisioned to the LDAP of services you are entitled access to. You can also upload your public SSH key. To display hidden files on a Mac enter <code>CMD-SHIFT-PERIOD</code>",
    ...
    collaboration: {
        ...
        shortNameTooltip: "Assign short names to collaborations so that these short names can be used in the LDAP services (like Linux group names)",
    ...
    service: {
        ...
        contact_emailTooltip: "This email address will be used as primary contact. Ideally this is a functional email address, like service_A_support@sp.org.",
    ...
    organisation: {
        ...
        shortNameTooltip: "Assign short names to organisations so that these short names can be used in the LDAP services (like Linux directory names)",
        identifier: "Identifier",
        ...
        servicesRestrictedTooltip: "When checked the collaborations in this service are restricted and only the platform admin can configure the services.",
    ...
    organisationServices: {
        ...
        serviceRestrictedOrganisationAdded: "This service is enabled for al collaborations but you can't edit this because this organisation is configured services restricted. ",
        flash: {
