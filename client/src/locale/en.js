...
I18n.translations.en = {
    ...
    groups: {
        ...
        shortNameTooltip: "A service group's short name will be used for groups provisioned to collaborations, prepended by short name of the service and separated by a hyphen '-'",
        identifier: "Identifier",
