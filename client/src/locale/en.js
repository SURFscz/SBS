const en = {
    ...
    header: {
        ...
        links: {
            ...
            requestService: "Register service",
            help: "Help",
            profile: "Profile",
            logout: "Logout",
    ...
    home: {
        ...
        tabs: {
            ...
            userTokens: "Service tokens",
            collaborationRequests: "Requests",
            joinRequests: "Join requests",
            myRequests: "My requests",
            serviceRequests: "Service registration",
    ...
    service: {
        ...
        accessAllowedForAllInfo: "Collaborations of all organisations can connect to this service.",
        ...
        contact_emailPlaceholder: "The email address or website of the administrative department for this service",
        contact_emailTooltip: "This administrative email address will be used as primary contact. Ideally this is a functional email address, like service_A_support@service.example.com.",
        ...
        security_emailPlaceholder: "The email address or website of the security department of this service",
        security_emailTooltip: "The security email address will be contacted if there are security questions. Ideally this is a functional email address, like service_A_security@service.example.com.",
        ...
        deleteConfirmation: "Are you sure you want to delete service {{name}}? This cannot be undone.",
        requestDeleteConfirmation: "Are you sure you want to send a request to delete service {{name}}? Once your request is honored then this cannot be undone.",
        deleteWarning: "You can not request the deletion of this service. Disconnect the collaborations first at the 'connected collaborations' tab.",
        add: "Create",
    ...
    organisation: {
        ...
        crmIdTooltip: "The organisation linked to this service through the CRM identifier",
    ...
    organisationServices: {
        ...
        noAccessAllowed: "This service cannot be enabled for all collaborations, because none collaborations can connect.",
    ...
    aup: {
        ...
        service: {
            ...
            singleInfoAccepted: "You have already agreed to the acceptable use policy for the service used by this collaboration.",
            multipleInfoAccepted: "You have already agreed to all of the acceptable use policies for the services used by this collaboration.",
        },
        organisation: {
    ...
    history: {
        ...
        tables: {
            ...
            "service_requests": "Service registration requests",
            "users": "User",
    ...
    serviceRequest: {
        title: {
            open: "{{requester}} has requested to register the service '{{name}}'.",
            approved: "{{requester}} service registration was approved.",
            denied: "{{requester}} service registration was denied."
        },
        request: "Request {{id}}",
        requester: "Requester",
        approved: "Approved",
        rejectionReason: "Denied reason",
        denyConfirmation: "Are you sure you want to deny this service registration?",
        deleteConfirmation: "Are you sure you want to delete this service registration?",
        approve: "Approve",
        deny: "Deny",
        ...
        flash: {
            ...
            denied: "Service registration request for {{name}} has been denied",
            deleted: "Service registration request for {{name}} has been deleted",
        }
    },
    confirmation: {
