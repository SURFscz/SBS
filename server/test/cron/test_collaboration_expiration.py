...
class TestCollaborationExpiration(AbstractTest):
    ...
    def test_schedule(self):
        ...
        with mail.record_messages() as outbox:
            ...
            self.assertEqual(uva_research_name, results["collaborations_expired"][0]["name"])
        ...
        self.assertEqual(STATUS_EXPIRED, self.find_entity_by_name(Collaboration, uva_research_name).status)
