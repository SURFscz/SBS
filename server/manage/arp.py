def arp_attributes():
    return {
        ...
        "urn:mace:dir:attribute-def:voPersonExternalID": [{
            "value": "*",
            "source": "idp",
