...
def upgrade():
    op.create_table("users",
                    ...
                    sa.Column("edu_members", sa.String(length=255), nullable=True),
                    sa.Column("affiliation", sa.Text(), nullable=True),
                    sa.Column("schac_home_organisation", sa.String(length=255), nullable=True),
    ...
    op.create_table("invitations",
                    ...
                    sa.Column("user_id", sa.Integer(), sa.ForeignKey("users.id", ondelete="cascade"),
                              nullable=False),
                    sa.Column("intended_role", sa.String(length=255), nullable=False, default="member"),
