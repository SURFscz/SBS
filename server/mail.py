...
from server.mail_types.mail_types import COLLABORATION_REQUEST_MAIL, \
    ...
    COLLABORATION_SUSPENSION_WARNING_MAIL, MEMBERSHIP_EXPIRED_NOTIFICATION_MAIL, MEMBERSHIP_EXPIRES_WARNING_MAIL_MEMBER, \
    MEMBERSHIP_EXPIRES_WARNING_MAIL_ADMIN, SERVICE_INVITATION_MAIL, ACCEPTED_SERVICE_REQUEST_MAIL, DENIED_SERVICE_REQUEST_MAIL
